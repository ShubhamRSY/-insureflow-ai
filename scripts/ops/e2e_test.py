...
Examples:
  python scripts/ops/e2e_test.py                    # live server :8002
  python scripts/ops/e2e_test.py --in-process       # TestClient (no server needed)
  python scripts/ops/e2e_test.py --port 8002 --json
