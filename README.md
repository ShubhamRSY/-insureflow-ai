...
docker compose -f docker-compose.yml -f deploy/docker-compose.bank.standalone.yml up --build
...
For the branded name **`https://app.ryterainc.com`**: Cloudflare Tunnel (free):

```bash
brew install cloudflared
cloudflared tunnel login          # opens browser — pick ryterainc.com zone
...
# → https://app.ryterainc.com/dashboard
```
...
Provisions: VPC, ALB + TLS, ECS Fargate, RDS Postgres, ElastiCache Redis, WAF, CloudTrail, Secrets Manager, Cognito.
