...
def test_gates_catalog_has_core_metrics() -> None:
...
def test_pass_when_above_thresholds() -> None:
...
def test_block_when_precision_low() -> None:
...
def test_flag_when_faithfulness_low_but_core_ok() -> None:
    result = apply_quality_gates(
        {
            "precision": 0.90,
            "recall": 0.92,
...
def test_gates_from_report_summary() -> None:
