...
def builtin_guidelines() -> UnderwritingGuidelines:
    return UnderwritingGuidelines(guidelines=[
        ...
        Guideline(
            ...
            keywords=["manufacturing", "occupancy", "sprinkler", "hot work", "combustible dust"],
            risk_impact="high",
        ),
        Guideline(
            id="OCC-002",
        ...
        Guideline(
            ...
            keywords=["loss ratio", "underwriter referral", "marginal", "non-renewal", "decline"],
            risk_impact="high",
        ),
        Guideline(
            id="COM-001",
            ...
            keywords=["compliance", "state", "surplus lines", "cancellation", "coastal", "deductible"],
            risk_impact="high",
        ),
        Guideline(
            id="COM-002",
