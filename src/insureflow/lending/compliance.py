...
LENDING_RULES: list[LendingRule] = [
    LendingRule("SBA-001", "SBA Size Standards", "critical",
                (LoanProductType.SBA_7A,), "Revenue must be under $15M for SBA 7(a)",
                "13 CFR 121", _check_sba_7a_size),
    LendingRule("SBA-002", "SBA 504 Maximum", "critical",
                (LoanProductType.SBA_504,), "Maximum SBA 504 loan amount is $5M",
                "13 CFR 120.882", _check_sba_504_requirements),
    LendingRule("REG-B-001", "ECOA Compliance", "info",
                tuple(LoanProductType), "Adverse action notice required on declines",
                "Reg B 12 CFR 1002", _check_reg_b_ecoaa),
    LendingRule("REG-Z-001", "TILA Disclosure", "info",
                tuple(LoanProductType), "Truth in Lending disclosure required",
                "Reg Z 12 CFR 1026", _check_truth_in_lending),
    LendingRule("BSA-001", "BSA/AML Check", "info",
                tuple(LoanProductType), "CDD and beneficial ownership required",
                "BSA 31 USC 5311", _check_bank_secrecy),
    ...
    LendingRule("CIP-002", "Consumer CIP", "critical",
                (LoanProductType.PERSONAL_TERM_LOAN, LoanProductType.PERSONAL_LINE_OF_CREDIT,
                 ...
                 LoanProductType.HOME_EQUITY_LOAN, LoanProductType.HOME_EQUITY_LINE,
                 LoanProductType.SECURED_PERSONAL, LoanProductType.UNSECURED_PERSONAL),
                "Consumer identity verification required", "31 CFR 1020.220", _check_consumer_cip),
    LendingRule("UDAAP-001", "UDAAP Screening", "info",
                (LoanProductType.PERSONAL_TERM_LOAN, LoanProductType.PERSONAL_LINE_OF_CREDIT,
                 LoanProductType.UNSECURED_PERSONAL),
                "Fair lending compliance check", "Dodd-Frank §1031", _check_udaap_prohibited),
    LendingRule("CREDIT-101", "Debt Service Coverage", "high",
                (LoanProductType.BUSINESS_TERM_LOAN, LoanProductType.BUSINESS_LINE_OF_CREDIT,
                 LoanProductType.COMMERCIAL_REAL_ESTATE, LoanProductType.CONSTRUCTION_LOAN,
    ...
    LendingRule("CREDIT-201", "Maximum DTI", "high",
                (LoanProductType.PERSONAL_TERM_LOAN, LoanProductType.PERSONAL_LINE_OF_CREDIT,
                 ...
                 LoanProductType.HOME_EQUITY_LOAN, LoanProductType.HOME_EQUITY_LINE,
                 LoanProductType.UNSECURED_PERSONAL),
                "DTI must be below 43%", "ATR/QM 12 CFR 1026.43", _check_consumer_dti),
    LendingRule("COLLAT-001", "Collateral Coverage", "moderate",
                (LoanProductType.BUSINESS_TERM_LOAN, LoanProductType.COMMERCIAL_REAL_ESTATE,
                 LoanProductType.CONSTRUCTION_LOAN, LoanProductType.SECURED_PERSONAL,
                 LoanProductType.AUTO_LOAN, LoanProductType.BOAT_LOAN),
                "LTV should be under 80%", "Interagency Loan Policy", _check_collateral_coverage),
    LendingRule("CONST-001", "Construction Collateral", "critical",
                (LoanProductType.CONSTRUCTION_LOAN, LoanProductType.COMMERCIAL_REAL_ESTATE),
                "Real estate collateral required", "Interagency CRE", _check_construction_loan),
]
