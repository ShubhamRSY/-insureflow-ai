...
export const endpoints = {
  ...
  pricingPlans: () => api('/pricing/plans'),
  ...
  validateUwTerms: (bundleId, body) => api(`/pipeline/workflow/${bundleId}/validate-terms`, { method: 'POST', body }),
  subjectivities: (bundleId) => api(`/pipeline/workflow/${bundleId}/subjectivities`),
  addSubjectivity: (bundleId, body) => api(`/pipeline/workflow/${bundleId}/subjectivities`, { method: 'POST', body }),
