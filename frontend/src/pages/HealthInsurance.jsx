...
export default function HealthInsuranceHub({ presets, onRunDemo, onSubmit, jobs }) {
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-slate-500">
                    {job?.results?.commercial_coverage_name
                      ? `${job?.results?.commercial_product_name || 'Health'} · ${job.results.commercial_coverage_name}`
                      : (job?.results?.commercial_product_name || job?.results?.insurance_line || 'Health')}
                  </p>
                </div>
